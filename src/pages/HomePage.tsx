...
export default function HomePage() {
  ...
  const features = lang === 'it' ? [
    ...
    { icon: Star, title: 'Qualità premium', desc: 'Hotel selezionati e servizi di alto livello' },
  ] : [
    ...
    { icon: Star, title: 'Premium jakość', desc: 'Wybrane hotele i usługi najwyższego poziomu' },
  ];
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 border-2 border-white/30 hover:border-teal text-white hover:text-teal font-semibold px-8 py-4 rounded-full text-lg transition-all"
            >
              <Camera size={20} />
              {t('gallery')}
            </Link>
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-orange hover:bg-orange/90 text-white font-bold px-8 py-4 rounded-full text-lg transition-all hover:scale-105 shadow-lg"
            >
              📧 {lang === 'it' ? 'Scrivici' : 'Napisz do nas'}
            </a>
            <a
