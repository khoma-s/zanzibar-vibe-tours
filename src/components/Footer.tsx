        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
          ...
          <div className="text-right">
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:info@zanzibarvibetours.com" className="flex items-center gap-3 text-cream/60 hover:text-teal text-sm transition-colors justify-end">
              ...
              <li>
                <a href="https://wa.me/255777123456" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-cream/60 hover:text-teal text-sm transition-colors justify-end">
